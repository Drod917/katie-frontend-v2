...
const ServiceModalTreatments = ({ title, setIsOpen }) => {
                ...
                <div className="modal-content">
                    <div className="modal-service-title">
                        ...
                        <div className='modal-service-item-extra'>
                            <p>Extra product charge $25/oz</p>
                        </div>
                        <div className='modal-service-item'>
                            <p>Keratin Original</p>
                            <p>$250</p>
                        </div>
                        <div className='modal-service-item-extra'>
                            <p>Extra product charge $50/oz</p>
                        </div>
                        <div className='modal-service-item'>
                            <p>Keratin Blonde</p>
                            <p>$250</p>
...
ServiceModalTreatments.propTypes = {
    isActive: PropTypes.bool
}

ServiceModalTreatments.defaultProps = {
    isActive: false
}

export default ServiceModalTreatments