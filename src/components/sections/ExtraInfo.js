    ...
    <>
      <div className="content-wrapper">
        <div className='extra-info'>
          <StaticImage className="welcome-hero" quality={100} src="../../content/images/extra-info-hero.jpg" alt="extra info hero" />
          ...
          <div className="extra-info-blurb-wrapper">
            <div className="extra-info-blurb">
              ...
              <StaticImage quality={100} objectFit="contain" height={222} width={222} id="blurb-img-1" src="../../content/images/extra-info-blurb-1.jpg" alt="extra info blurb 1" />
            </div>
      ...
      <div className="bg-colored">
        <div className="content-wrapper">
          <div className="extra-info-2">
            <StaticImage className="square-img" quality={100} objectFit="cover" src="../../content/images/extra-info-blurb-3.jpg" alt="extra info blurb 3" />
      ...
      <div className="content-wrapper">
        <div className="extra-info-end">
          <StaticImage quality={100} objectFit="contain" height={315} width={315} src="../../content/images/extra-info-blurb-5.jpg" alt="extra info blurb 5" />
